...
public:
	static void init(lua_State* L) {
		...
		registerMethod(L, "Mount", "getName", luaMountGetName);
		registerMethod(L, "Mount", "getId", luaMountGetId);
		registerMethod(L, "Mount", "getClientId", luaMountGetClientId);
		registerMethod(L, "Mount", "getSpeed", luaMountGetSpeed);
	}
