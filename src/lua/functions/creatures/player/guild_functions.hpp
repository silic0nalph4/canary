...
public:
	static void init(lua_State* L) {
		...
		registerMethod(L, "Guild", "getId", luaGuildGetId);
		registerMethod(L, "Guild", "getName", luaGuildGetName);
		registerMethod(L, "Guild", "getMembersOnline", luaGuildGetMembersOnline);

		registerMethod(L, "Guild", "getBankBalance", luaGuildGetBankBalance);
		registerMethod(L, "Guild", "setBankBalance", luaGuildSetBankBalance);

		registerMethod(L, "Guild", "addRank", luaGuildAddRank);
		registerMethod(L, "Guild", "getRankById", luaGuildGetRankById);
		registerMethod(L, "Guild", "getRankByLevel", luaGuildGetRankByLevel);

		registerMethod(L, "Guild", "getMotd", luaGuildGetMotd);
		registerMethod(L, "Guild", "setMotd", luaGuildSetMotd);
	}
