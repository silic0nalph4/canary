...
public:
	static void init(lua_State* L) {
		...
		registerMethod(L, "Combat", "setParameter", luaCombatSetParameter);
		registerMethod(L, "Combat", "setFormula", luaCombatSetFormula);

		registerMethod(L, "Combat", "setArea", luaCombatSetArea);
		registerMethod(L, "Combat", "addCondition", luaCombatSetCondition);
		registerMethod(L, "Combat", "setCallback", luaCombatSetCallback);
		registerMethod(L, "Combat", "setOrigin", luaCombatSetOrigin);

		registerMethod(L, "Combat", "execute", luaCombatExecute);
