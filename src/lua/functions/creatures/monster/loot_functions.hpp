...
public:
	static void init(lua_State* L) {
		...
		registerMethod(L, "Loot", "setId", luaLootSetId);
		registerMethod(L, "Loot", "setIdFromName", luaLootSetIdFromName);
		registerMethod(L, "Loot", "setMinCount", luaLootSetMinCount);
		registerMethod(L, "Loot", "setMaxCount", luaLootSetMaxCount);
		registerMethod(L, "Loot", "setSubType", luaLootSetSubType);
		registerMethod(L, "Loot", "setChance", luaLootSetChance);
		registerMethod(L, "Loot", "setActionId", luaLootSetActionId);
		registerMethod(L, "Loot", "setText", luaLootSetText);
		registerMethod(L, "Loot", "setNameItem", luaLootSetNameItem);
		registerMethod(L, "Loot", "setArticle", luaLootSetArticle);
		registerMethod(L, "Loot", "setAttack", luaLootSetAttack);
		registerMethod(L, "Loot", "setDefense", luaLootSetDefense);
		registerMethod(L, "Loot", "setExtraDefense", luaLootSetExtraDefense);
		registerMethod(L, "Loot", "setArmor", luaLootSetArmor);
		registerMethod(L, "Loot", "setShootRange", luaLootSetShootRange);
		registerMethod(L, "Loot", "setHitChance", luaLootSetHitChance);
		registerMethod(L, "Loot", "setUnique", luaLootSetUnique);
		registerMethod(L, "Loot", "addChildLoot", luaLootAddChildLoot);
	}
