...
public:
	static void init(lua_State* L) {
		...
		registerMethod(L, "Action", "aid", luaActionActionId);
		registerMethod(L, "Action", "uid", luaActionUniqueId);
		registerMethod(L, "Action", "allowFarUse", luaActionAllowFarUse);
		registerMethod(L, "Action", "blockWalls", luaActionBlockWalls);
		registerMethod(L, "Action", "checkFloor", luaActionCheckFloor);
	}
